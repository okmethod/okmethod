...
| プロセス                     | 変換            | 場                                | 内容                                                                                               | 典型的な場・活動                         |
| ---------------------------- | --------------- | --------------------------------- | -------------------------------------------------------------------------------------------------- | ---------------------------------------- |
| **共同化** (Socialization)   | 暗黙知 → 暗黙知 | **創出の場** (Originating Ba)     | 個人間または小グループ内で、観察・模倣・共同体験を通じて暗黙知を共有する                           | 徒弟制度、OJT、合宿                      |
| **表出化** (Externalization) | 暗黙知 → 形式知 | **対話の場** (Dialoguing Ba)      | 個人または小グループが有する暗黙知を、対話・メタファー・アナロジーを通じて概念・言語として表現する | コンセプト開発、ドキュメント化           |
| **連結化** (Combination)     | 形式知 → 形式知 | **システムの場** (Systemizing Ba) | 表出した形式知が小グループを超えて流通し、分類・統合されて新たな形式知が生み出される               | 会議、データ分析、マニュアル整備         |
| **内面化** (Internalization) | 形式知 → 暗黙知 | **実践の場** (Exercising Ba)      | 創造され流通している形式知を個人が実践・反復し、身体化・内面化する                                 | 実地訓練、ロールプレイ、シミュレーション |
...
以下の要件を満たす組織が、「個人」の知識創造と、「組織」のスパイラルを促進する。
...
ただし、弁証法が二項対立の「統合」を革新とするのに対し、SECIモデルは共同化（暗黙知→暗黙知）という「対立なき共鳴」のステップを含む。  
...
- **実証的根拠の薄さ**: バブル期の少数の日本企業の成功体験事例（ホンダ・キヤノン等）からの帰納的理論化であり、普遍性に疑問が残る。
...
- これはSECIモデルへの批判でもある「暗黙知は完全には形式化できない」の証左かもしれない。（ポランにーへの回帰）
